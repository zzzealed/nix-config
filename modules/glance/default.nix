{ pkgs, config, ... }:
{
  ...
  age.secrets."glance-custom-api_kredslob_skrald".file =
    ../../secrets/glance-custom-api_kredslob_skrald.age;
          ...
          columns = [
            {
              ...
              widgets = [
                ...
                }
                {
                  ...
                  hour-format = "24h";
                  location = {
                    _secret = config.age.secrets."glance-weather_location".path;
                  };
                }
                {
                  type = "server-stats";
              ...
              widgets = [
                ...
                }
                {
                  ...
                  feeds = [
                    ...
                    {
                      url = {
                        _secret = config.age.secrets."changedetection-io_rss".path;
                      };
                      title = "ChangeDetection";
                    }
                    {
            ...
            }
            {
              ...
              widgets = [
                ...
                }
                {
                  ...
                  url = "https://pihole.l.zzzealed.com";
                  password = {
                    _secret = config.age.secrets."pihole-app_password".path;
                  };
                  hour-format = "24h";
