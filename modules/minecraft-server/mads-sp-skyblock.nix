  ...
  services.minecraft-servers = {
    servers.mads-sp-skyblock = {
      ...
      serverProperties = {
        ...
        max-players = 1;
        motd = "Mads' Single Player Skyblock (glitchless)";
      ...
      symlinks = {
        ...
        mods = with pkgs; pkgs.linkFarmFromDrvs "mods" ( builtins.attrValues {
          ...
          SkyblockInfinite = fetchurl { url = "https://cdn.modrinth.com/data/YVMr2l79/versions/lslOuqvS/skyblock-infinite-1.1.12.jar"; sha512 = "5bfb939cd7861855dd00becbdd02f33308b0e26831934817ee69ff1af5e833710aa65522f1b4388322d175452eadafcdbd441469dbf5d9999184bb0e0f9e5cb1"; };
