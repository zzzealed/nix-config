let
  ...
  decodingKeys = [ root_desktop-nixos root_server-nixos root_pi-nixos root_vps-nixos ];
  ...
  secrets = {
    ...
    "porkbun-nginx_api_key.age".publicKeys = [ root_server-nixos root_vps-nixos ] ++ interactiveKeys;
    "porkbun-nginx_api_secret.age".publicKeys = [ root_server-nixos root_vps-nixos ] ++ interactiveKeys;
